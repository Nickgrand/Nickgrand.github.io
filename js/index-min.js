...
!function () {
    ...
    new Vue({
        ...
        methods: {
            appendDialog: function (n) {
                ...
                var s = this, a = e(t), u = a.replace(/<[^>]+>/g, "").length, l = /<img[^>]+>/.test(a), h = u > 2 || l,
                    c = {
                        author: n,
                        content: h ? '\n        <div class="dot"></div>\n        <div class="dot"></div>\n        <div class="dot"></div>\n    ' : a,
                        isImg: l
                ...
                return this.messages.push({author: n, content: t}), o(), Promise.resolve()
            }, markMsgSize: function (t) {
                var n = this, e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
    ...
    function i() {
        var t = $("#mobile-body-content"), n = t[0].scrollHeight - t.height() - t.scrollTop(), e = Date.now();
